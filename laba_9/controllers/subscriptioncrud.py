...
class SubscriptionCRUD:
    ...
    def get_user_subscriptions(self, user_id: int):
        ...
        cur.execute("""
            SELECT currencies_const.id, currencies_const.num_code, currencies_const.char_code, currencies_const.name, currencies_const.value, currencies_const.nominal
            FROM subscriptions
            JOIN currencies_const ON subscriptions.currency_id = currencies_const.id

...
from main import solve_quadratic_log
...
def demonstrate_quadratic():
    ...
    try:
        result = solve_quadratic_log(1, -3, 2)
    ...
    try:
        result = solve_quadratic_log(1, 0, 1)
        print(f"Результат: {result}")
    except Exception as e:
        print(f"Ошибка: {e}")
    ...
    try:
        result = solve_quadratic_log("abc", 1, 2)
        print(f"Результат: {result}")
    except Exception as e:
        print(f"Ошибка: {e}")
    ...
    try:
        result = solve_quadratic_log(0, 0, 5)
        print(f"Результат: {result}")
    except Exception as e:
        print(f"Ошибка: {e}")
